  ...
  sources = {
    "@vscode/l10n-0.0.18" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "KYSIHVmslkaCDyw013pphY+d7x1qV8IZupYfeIfzNA+nsaWHbn5uPuQRvdRFsa9zFzGeudPuoGoZ1Op4jrJXIQ==";
      };
    };
    "@vtsls/language-service-0.2.5" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/@vtsls/language-service/-/language-service-0.2.5.tgz";
        sha512 =
          "jf4624do1ZpZLEi4Q2NPZPjACpYRP+TNj3Xtc9kTs+llJDY26zQd1Yfcw9G/uDEREZAN958UTfAjkbuEkVNLYA==";
      };
    };
    "@vtsls/vscode-fuzzy-0.0.1" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/@vtsls/vscode-fuzzy/-/vscode-fuzzy-0.0.1.tgz";
        sha512 =
          "2KCtA+/OmPVttsdVggO0WQFXZwM0zbG7G8KRGExe4YeoaHB0fDWyfsNrWnutnFVRlpmu8quVTjTI15YK6KGCFw==";
      };
    };
    "jsonc-parser-3.3.1" = {
      name = "jsonc-parser";
      ...
      src = fetchurl {
        ...
        sha512 =
          "HUgH65KyejrUFPvHFPbqOY0rsFip3Bo5wb4ngvdi1EpCYWUQDC5V+Y7mZws+DLkr4M//zQJoanu1SP+87Dv1oQ==";
      };
    };
    "lru-cache-6.0.0" = {
      name = "lru-cache";
    ...
    "semver-7.5.2" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "SoftuTROv/cRjCze/scjGyiDtcUyxw1rgYQSZY7XTmtR5hX+dm76iDbTH8TkLPHCQmlbQVSSbNZCPM2hb0knnQ==";
      };
    };
    "typescript-5.5.2" = {
      name = "typescript";
      ...
      src = fetchurl {
        ...
        sha512 =
          "NcRtPEOsPFFWjobJEtfihkLCZCXZt/os3zf8nTxjVH3RvTSxjrCamJpbExGvYOF+tFHc3pA65qpdwPbzjohhew==";
      };
    };
    "vscode-jsonrpc-8.2.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "C+r0eKJUIfiDIfwJhria30+TYWPtuHJXHtI7J0YlOmKAo7ogxP20T0zxB7HZQIFhIyvoBPwWskjxrvAtfjyZfA==";
      };
    };
    "vscode-languageserver-9.0.1" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "woByF3PDpkHFUreUa7Hos7+pUWdeWMXRd26+ZX2A8cFx6v/JPTtd4/uN0/jB6XQHYaOlHbio03NTHCqrgG5n7g==";
      };
    };
    "vscode-languageserver-protocol-3.17.5" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "mb1bvRJN8SVznADSGWM9u/b07H7Ecg0I3OgXDuLdn307rl/J3A9YD6/eYOssqhecL27hK1IPZAsaqh00i/Jljg==";
      };
    };
    ...
    "vscode-languageserver-types-3.17.5" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "Ld1VelNuX9pdF39h2Hgaeb5hEZM2Z3jUrrMgWQAu82jMtZp7p3vJT3BzToKtZI7NgQssZje5o0zryOrhQvzQAg==";
      };
    };
    "vscode-uri-3.0.8" = {
      name = "vscode-uri";
...
in {
  "@vtsls/language-server" = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      url =
        "https://registry.npmjs.org/@vtsls/language-server/-/language-server-0.2.5.tgz";
      sha512 =
        "CBPLSlyLi4zLqteKCpHsVh+IV+ok5MxKYYAt6oPXO1jND361EvAg3ioYGGtW7zpRbu5w19nuAvEI8iYzR59FHw==";
    };
    dependencies = [
