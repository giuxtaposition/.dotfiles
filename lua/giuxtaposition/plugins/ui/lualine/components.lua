...
M.branch = {
  "branch",
  icons_enabled = false,
  icon = hl_str(icons.git.github, "SLGitIcon", "SLBranchName"),
  colored = false,
  fmt = function(str)
    ...
    prev_branch = str
    local icon = hl_str(icons.git.github .. " ", "SLGitIcon", "SLBranchName")
...
M.mode = {
  ...
  fmt = function(str)
    ...
    return left_sep .. hl_str(str, "SLMode" .. str:gsub("(%a)([%w_']*)", tchelper)) .. right_sep
  end,
}
