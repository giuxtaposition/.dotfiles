...
local function worker(user_args)
	local calendar_theme = {
		...
		focus_date_bg = beautiful.lavender,
		focus_date_fg = beautiful.bg_dark,
		weekend_day_bg = beautiful.bg_light,
		weekday_fg = beautiful.lavender,
		header_fg = beautiful.mauve,
		border = beautiful.bg_dark,
	}
