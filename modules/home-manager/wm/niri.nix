{
  ...
  options.niri = {
    ...
    extraConfig = lib.mkOption {
      ...
      default = "";
      description = "Extra KDL config appended to the niri config file (for host-specific settings like outputs)";
    };
  };
  ...
  config = lib.mkIf config.niri.enable {
    ...
    xdg.configFile."niri/config.kdl".text = ''
      ...
      window-rule {
          match app-id=r#"^\.blueman-manager-wrapped$"# title="^Bluetooth Devices$"
          open-floating true
      }
      ...
      layer-rule {
          match namespace="(toast|osd|noctalia-popup)"
